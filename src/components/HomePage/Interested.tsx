const Interested = () => {
    ...
    return ( 
        <main className="relative z-10 text-center px-5 sm:px-10 md:px-20 xl:px-32 -mt-10 ">
            <div className="flex flex-col gap-y-5 p-4 md:p-8 xl:p-10 border border-gray-300 dark:border-gray-600 bg-bgLight text-textLight dark:bg-bgDark dark:text-textDark">
