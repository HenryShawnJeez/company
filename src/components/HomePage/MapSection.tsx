    ...
    return ( 
        <main className="flex flex-col gap-y-5 md:gap-y-0 md:flex-row md:justify-between px-5 sm:px-10 md:px-20 xl:px-32 py-6 mt-20">
            <div className="flex flex-col gap-y-3 w-full md:w-[45%] lg:w-[48%]">
                ...
                <h1 className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-medium">Nestled in the heart of the Netherlands at Einsteinstraat 26, 3281 NJ Numansdorp and after over twenty(20) years in the business, we have learned a few things.</h1>
