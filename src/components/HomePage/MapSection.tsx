...
const MapSection = () => {
    return ( 
        <main className="flex flex-col gap-y-5 lg:gap-y-0 lg:flex-row lg:justify-between px-5 sm:px-10 md:px-20 xl:px-32 py-6 mt-20">
            <div className="flex flex-col gap-y-3 w-full lg:w-[45%] xl:w-[48%]">
                ...
                <Link href="/contact" className="font-medium my-10 px-10 py-3 md:py-4 max-w-fit dark:bg-bgLight bg-bgDark dark:text-textLight text-textDark transition hover:-translate-y-2 duration-300">Get Started</Link>
           </div>
            <div className="w-full lg:w-[45%] xl:w-[48%]">
                <Image src={map} alt="Map" className="relative mx-auto w-full sm:w-[90%] md:w-[70%] xl:w-[80%]"/>
            </div>
        </main>
     );
}
